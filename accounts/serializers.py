...
class AddPremiumSerializer(serializers.ModelSerializer):
    class Meta:
        model = Profile
        fields = ['Premium','Premium_plan','premium_Validity','PremiumDaysLeft','premium_start_date']
    def update(self, instance, validated_data):
        ...
        instance.premium_start_date = validated_data.get('premium_start_date', instance.premium_start_date)

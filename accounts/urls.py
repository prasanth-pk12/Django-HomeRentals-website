...
from .views import SendOTPphone,validateOTP,Register,LoginAPI,ChangePasswordView,EditProfile,logoutview,\
    ProfileView,UpdateProfileView,UserAvatarUpload,goToResetPass,ConfirmResetPass,ConfirmPassreset,GetPremiumPlan,ShowPremiumPlan,AddPremiumMembership,ContactUs,stripe_checkout
urlpatterns = [
